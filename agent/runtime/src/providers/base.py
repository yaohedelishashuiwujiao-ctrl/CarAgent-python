...
class BaseProvider(ABC):
    ...
    def format_tool_choice(self, mode: str, tool_name: str | None = None) -> Any | None:
        """Translate Runtime's provider-neutral tool choice into API payload.

        Providers advertise only modes they actually support. Returning None
        makes Runtime fall back to candidate narrowing plus explicit guidance.
        """
        return None
